...
const userJourney: JourneyStep[] = [
  { step: 'Landing Page', action: 'Page View', users: 50000, completion: 100, avgTime: '0:45' },
  { step: 'Product Browse', action: 'Category View', users: 35000, completion: 70, avgTime: '2:30' },
  { step: 'Product Detail', action: 'Product View', users: 25000, completion: 50, avgTime: '3:15' },
  { step: 'Add to Cart', action: 'Cart Addition', users: 8750, completion: 17.5, avgTime: '1:20' },
  { step: 'Cart Review', action: 'Cart View', users: 7500, completion: 15, avgTime: '2:45' },
  { step: 'Checkout Start', action: 'Checkout Begin', users: 5250, completion: 10.5, avgTime: '0:30' },
  { step: 'Payment Info', action: 'Payment Form', users: 4200, completion: 8.4, avgTime: '1:45' },
  { step: 'Order Complete', action: 'Purchase', users: 3675, completion: 7.35, avgTime: '0:15' }
];
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center space-x-4 text-right">
                          <div>
                            <p className="text-sm font-medium">{step.users.toLocaleString()}</p>
                            <p className="text-xs text-muted-foreground">users</p>
                          </div>
                          <div>
                            <p className="text-sm font-medium">{step.conversion}%</p>
                            <p className="text-xs text-muted-foreground">conversion</p>
                          </div>
                          <div>
                            <p className="text-sm font-medium">{step.averageTime}</p>
            ...
            <CardContent>
              <div className="space-y-4">
                {userJourney.map((step, index) => (
                  <div key={step.step} className="flex items-center justify-between p-3 rounded-lg border">
                    ...
                    <div className="flex items-center space-x-6 text-right">
                      ...
                      <div>
                        <p className="text-sm font-medium">{step.completion}%</p>
                      ...
                      <Badge variant={step.completion > 50 ? 'default' : step.completion > 20 ? 'secondary' : 'destructive'}>
                        {step.completion > 50 ? 'Good' : step.completion > 20 ? 'Fair' : 'Poor'}
                      </Badge>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg border-l-4 border-l-red-500 bg-red-50 dark:bg-red-950/20">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-sm font-medium text-red-800 dark:text-red-200">High Cart Abandonment</h4>
                      <p className="text-sm text-red-600 dark:text-red-300 mt-1">
                        65% of users abandon their cart at the consideration stage
                      </p>
                    </div>
                ...
                <div className="p-4 rounded-lg border-l-4 border-l-yellow-500 bg-yellow-50 dark:bg-yellow-950/20">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-sm font-medium text-yellow-800 dark:text-yellow-200">Checkout Drop-off</h4>
                ...
                <div className="p-4 rounded-lg border-l-4 border-l-green-500 bg-green-50 dark:bg-green-950/20">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-sm font-medium text-green-800 dark:text-green-200">Mobile Optimization</h4>
            ...
            <CardContent>
              <div className="h-96 flex items-center justify-center bg-muted/20 rounded-lg border-2 border-dashed border-muted-foreground/25">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Track conversion rates by user acquisition date</p>
                </div>
              </div>
            </CardContent>
          </Card>
