                ...
                {hasSubmenu ? (
                  <>
                    <button
                      ...
                      style={{
                        backgroundColor: isItemActive || isSubmenuItemActive 
                    ...
                    <AnimatePresence>
                      {!isCollapsed && isExpanded && (
                        <motion.div
                          ...
                          transition={{ duration: 0.2 }}
                          className="ml-4 mt-1 space-y-1 overflow-hidden border-l border-border/50 pl-4"
                        >
                              ...
                              <motion.div
                                ...
                                onMouseEnter={(e) => {
                                  if (pathname !== subItem.href) {
                                    ...
                                    e.currentTarget.style.color = 'hsl(var(--accent-hover-foreground))';
                                  }
                                }}
                                onMouseLeave={(e) => {
                                  if (pathname !== subItem.href) {
