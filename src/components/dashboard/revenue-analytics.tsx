                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground flex items-center space-x-2 text-xs">
                      ...
                      <Badge
                        variant={
                          source.trend === 'up' ? 'default' : 'secondary'
                        }
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Revenue performance by day</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <LineChartComponent
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-muted-foreground text-xs">75.9%</p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-muted-foreground text-xs">17.2%</p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="bg-primary/20 flex h-4 w-4 items-center justify-center rounded">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-muted-foreground text-xs">5.5%</p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="flex h-4 w-4 items-center justify-center rounded bg-yellow-500/20">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-muted-foreground text-xs">1.4%</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <div className="bg-muted/20 border-muted-foreground/25 flex h-96 items-center justify-center rounded-lg border-2 border-dashed">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    YoY comparison, seasonality, and growth patterns
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="cohorts" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="bg-muted/20 border-muted-foreground/25 flex h-96 items-center justify-center rounded-lg border-2 border-dashed">
                <div className="text-center">
                  <PieChart className="text-muted-foreground mx-auto mb-4 h-16 w-16" />
                  <p className="text-muted-foreground text-lg font-medium">
                    Cohort Analysis
                  </p>
                  <p className="text-muted-foreground text-sm">
                    Revenue tracking by customer acquisition cohorts
                  </p>
                </div>
              </div>
            </CardContent>
