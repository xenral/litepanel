      ...
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive table examples with sorting, filtering, and
      ...
      <Tabs defaultValue="basic" className="space-y-6">
        ...
        <TabsContent value="basic" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="rounded-md border">
                <Table>
                  <TableCaption>
                    A list of recent users and their information.
                  </TableCaption>
                  <TableHeader>
                    <TableRow>
          ...
          <Alert>
            ...
            <AlertDescription>
              Basic tables are perfect for simple data display with consistent
              formatting. Use TableCaption for accessibility and TableFooter for
              summary information.
            </AlertDescription>
          </Alert>
        </TabsContent>
            ...
            <CardHeader>
              <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                <div>
                  ...
                  <CardDescription>
                    Feature-rich table with avatars, progress bars, ratings, and
                    sorting
                  </CardDescription>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <TableHeader>
                    <TableRow>
                      <TableHead className="w-12">
                        <Checkbox
                          checked={
                            selectedRows.length === filteredAdvancedData.length
                          }
                          onCheckedChange={() =>
                            handleSelectAll(filteredAdvancedData)
                          }
                        />
                      </TableHead>
                      <TableHead>
        ...
        <TabsContent value="expandable" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Table with collapsible rows that reveal additional details and
                nested data
              </CardDescription>
            </CardHeader>
            <CardContent>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-2">
                              <div className="flex -space-x-2">
                                {Array.from(
                                  { length: Math.min(project.team, 3) },
                                  (_, i) => (
                                    <div
                                      key={i}
                                      className="bg-muted border-background flex h-6 w-6 items-center justify-center rounded-full border-2 text-xs"
                                    >
                                      {i + 1}
                                    </div>
                                  )
        ...
        <TabsContent value="interactive" className="space-y-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Use pagination or virtual scrolling for large datasets to
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Include proper table captions, headers, and ARIA labels
                      for screen readers.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Consider stacked layouts or horizontal scrolling for
                      narrow screens.
                    </p>
                  </div>

                  <div className="space-y-2">
                    <h4 className="text-sm font-medium">Visual Hierarchy</h4>
                    <p className="text-muted-foreground text-sm">
                      Use consistent spacing, typography, and color coding to
          ...
          <Alert>
            ...
            <AlertDescription>
              Remember to implement proper loading states, error handling, and
              empty states for production tables. Consider using libraries like
              TanStack Table for complex data management needs.
            </AlertDescription>
          </Alert>
        </TabsContent>
      </Tabs>
