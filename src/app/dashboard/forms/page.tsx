...
export const metadata: Metadata = {
  title: 'Forms',
  description:
    'Form wizard, validation examples, and interactive form components',
};
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Interactive forms with validation, multi-step wizards, and rich
            input components.
          </p>
        </div>
                  ...
                  return (
                    <div key={step.id} className="flex items-center">
                      ...
                      {index < wizardSteps.length - 1 && (
                        <div className="bg-border mx-4 h-px w-16" />
                      )}
                    </div>
                  );
                })}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="pr-12"
                      />
                      <div className="text-muted-foreground absolute right-3 top-1/2 -translate-y-1/2 transform text-xs">
                        0/250
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {formExamples.map((example) => (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="mb-2 text-sm font-medium">Form Fields:</h4>
                  ...
                  <div>
                    <h4 className="mb-2 text-sm font-medium">Validations:</h4>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-muted/20 min-h-24 rounded-lg border p-4">
                    <p className="text-muted-foreground text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 rounded-lg border p-2">
                    ...
                    <Input
                      placeholder="Add tag..."
                      className="h-6 min-w-24 flex-1 border-0 p-0 text-sm"
                    />
                  </div>
                </div>
              </CardContent>
