 ...
 */
const colorPalette = [
  { name: 'Primary', value: 'hsl(221.2 83.2% 53.3%)', class: 'bg-primary', description: 'Main brand color' },
  { name: 'Secondary', value: 'hsl(210 40% 96%)', class: 'bg-secondary', description: 'Supporting colors' },
  { name: 'Destructive', value: 'hsl(0 84.2% 60.2%)', class: 'bg-destructive', description: 'Error states' },
  { name: 'Muted', value: 'hsl(210 40% 96%)', class: 'bg-muted', description: 'Subtle backgrounds' },
  { name: 'Accent', value: 'hsl(210 40% 96%)', class: 'bg-accent', description: 'Highlights' },
  { name: 'Success', value: 'hsl(142.1 76.2% 36.3%)', class: 'bg-green-600', description: 'Success states' },
  { name: 'Warning', value: 'hsl(38 92% 50%)', class: 'bg-yellow-500', description: 'Warning states' },
  { name: 'Info', value: 'hsl(221.2 83.2% 53.3%)', class: 'bg-blue-600', description: 'Informational' }
];
...
const componentStats = [
  { label: 'Total Components', value: '77', icon: Package, change: '+5 this month' },
  { label: 'Categories', value: '6', icon: Grid, change: 'Fully organized' },
  { label: 'Design Tokens', value: '156', icon: Palette, change: '+12 new tokens' },
  { label: 'Usage Examples', value: '240+', icon: Code, change: 'Live examples' }
];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Professional UI components built with React, TypeScript, and Tailwind CSS.
          </p>
        </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-dashed border-muted rounded-lg p-8 bg-muted/20 min-h-48 flex items-center justify-center">
            ...
            <CardContent>
              <Tabs defaultValue="buttons" className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-3">
                          <div>
                            <h5 className="font-medium mb-2">Primary Buttons</h5>
                          ...
                          <div>
                            <h5 className="font-medium mb-2">Secondary Styles</h5>
                            <div className="flex flex-wrap gap-2">
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-3">
                          <div>
                            <h5 className="font-medium mb-2">Interactive States</h5>
                            <div className="flex flex-wrap gap-2">
                          ...
                          <div>
                            <h5 className="font-medium mb-2">Special Variants</h5>
                            <div className="flex flex-wrap gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Content display components</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <Card className="border-2">
                          ...
                          <CardContent>
                            <p className="text-sm text-muted-foreground">
                              Card content goes here with additional information and details.
                            </p>
                          </CardContent>
                        </Card>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Visual status and progress elements</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="space-y-3">
                          <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Skeleton loaders and indicators</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="space-y-3">
                          <div>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-lg">Alert Messages</CardTitle>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Tabs, menus, and navigation</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="space-y-4">
                          <div>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-lg">Dialog & Overlays</CardTitle>
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-3">
                              ...
                              <Dialog>
                                ...
                                <DialogContent>
                                  <DialogHeader>
                                    ...
                                    <DialogDescription>
                                      This is a sample dialog with customizable content.
                                    </DialogDescription>
                                  </DialogHeader>
                          ...
                          <div>
                            <Label className="text-sm">Interactive Buttons</Label>
                ...
                <TabsContent value="colors" className="space-y-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Design System Colors</CardTitle>
                      <CardDescription>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {colorPalette.map((color) => (
                          <div key={color.name} className="space-y-2">
                            <div className={`h-24 w-full rounded-lg ${color.class} border shadow-sm`} />
                            <div>
                      ...
                      <div className="mt-8">
                        <h4 className="font-medium mb-4">Color Usage Examples</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-3">
