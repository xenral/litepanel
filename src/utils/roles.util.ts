 ...
 */
export const canDeleteRole = (role: any): { canDelete: boolean; reason?: string } => {
  if (role.isSystem) {
 ...
 */
export const sortRoles = (roles: any[], sortBy: 'name' | 'userCount' | 'createdAt', ascending = true): any[] => {
